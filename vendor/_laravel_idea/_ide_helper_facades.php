...
namespace Illuminate\Support\Facades {
     ...
     * @method static \Illuminate\Support\ServiceProvider|null|string register(\Illuminate\Support\ServiceProvider|string $provider, bool $force = false)
     ...
     * @method static \Illuminate\Foundation\never abort(int $code, string $message = '', array $headers = [])
     ...
     * @method static \Illuminate\Auth\Access\Illuminate\Auth\Access\Response|\Illuminate\Auth\Access\Response inspect(string $ability, array|mixed $arguments = [])
     */
    class Gate {}
     ...
     * @method static \Illuminate\Http\Concerns\never dd(...$keys)
...
namespace Livewire {
     ...
     * @method static array|\Illuminate\Contracts\Foundation\Application|\Illuminate\Foundation\Application|\Illuminate\Http\Request|\Illuminate\Support\Stringable|mixed|null|string|__anonymous@199 originalPath()
     ...
     * @method static array|\Illuminate\Contracts\Foundation\Application|\Illuminate\Foundation\Application|\Illuminate\Http\Request|mixed|null|string originalMethod()
...
namespace Spatie\SignalAwareCommand\Facades {
    ...
    /**
     * @see \Spatie\SignalAwareCommand\Signal::executeSignalHandlers
     * @method static \Spatie\SignalAwareCommand\Signal executeSignalHandlers(int $signal, \Illuminate\Console\Command $command)
     * @see \Spatie\SignalAwareCommand\Signal::clearHandlers
     * @method static \Spatie\SignalAwareCommand\Signal clearHandlers(int $signal = null)
     * @see \Spatie\SignalAwareCommand\Signal::handle
     * @method static \Spatie\SignalAwareCommand\Signal handle(int $signal, callable $callable)
     */
    class Signal {}
}
